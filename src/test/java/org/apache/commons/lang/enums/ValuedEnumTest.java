 ...
 * @version $Id: ValuedEnumTest.java 905636 2010-02-02 14:03:32Z niallp $
 */
...
public final class ValuedEnumTest extends TestCase {
    ...
    public void testCompareTo_classloader_equal() throws Exception {
        ...
        if (cl instanceof URLClassLoader) {
            ...
            URLClassLoader urlCL1 = new URLClassLoader(urlCL.getURLs(), Thread.currentThread().getContextClassLoader());
            URLClassLoader urlCL2 = new URLClassLoader(urlCL.getURLs(), Thread.currentThread().getContextClassLoader());
